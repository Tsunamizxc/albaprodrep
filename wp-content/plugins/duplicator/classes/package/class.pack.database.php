...
//Compatibility mode
    ...
    {
        global $wpdb;
        // wait_timeout is MySQL-only; ignore on SQLite to avoid HTML error output corrupting the dump.
        if (!(defined('DB_ENGINE') && DB_ENGINE === 'sqlite') && (isset($wpdb->dbh) && $wpdb->dbh instanceof \mysqli)) {
...
//BUILD CREATES:
        ...
        // SQLite integration does not support PROCEDURE/FUNCTION/VIEW SHOW statements — skip to avoid dump errors.
